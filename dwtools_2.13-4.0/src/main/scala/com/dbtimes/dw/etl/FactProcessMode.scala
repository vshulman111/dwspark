...
private[etl] object FactProcessMode extends Enumeration {
  private[etl] type FactProcessMode = Value
  private[etl] val REPLACE, REPLACE_PARTITION, MERGE, MERGE_PARTITION, ADD = Value
}
