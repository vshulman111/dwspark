...
private[etl] object EffectiveDateRule extends Enumeration {
  private[etl] type EffectiveDateRule = Value
  private[etl] val DISTINCT_DATES, WEEKDAYS, ALL_DATES, MAX_DATE, MIN_DATE = Value
}
